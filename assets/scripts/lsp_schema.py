...
#   timestamp: 2026-04-05T06:34:52+00:00
...
class BooleanLiteralType(TypedDict, closed=True):
    """
...
class EnumerationEntry(TypedDict, closed=True):
    """
...
class EnumerationType(TypedDict, closed=True):
    kind: Literal["base"]
    name: Literal["string", "integer", "uinteger"]


class IntegerLiteralType(TypedDict, closed=True):
...
class MapKeyType1(TypedDict, closed=True):
    """
...
class ReferenceType(TypedDict, closed=True):
    """
...
class StringLiteralType(TypedDict, closed=True):
    """
...
class BaseType(TypedDict, closed=True):
    """
...
class Enumeration(TypedDict, closed=True):
    """
...
type MapKeyType = MapKeyType1 | ReferenceType
"""
Represents a type that can be used as a key in a map type. If a reference type is used then the type must either resolve to a `string` or `integer` type. (e.g. `type ChangeAnnotationIdentifier === string`).
"""


class AndType(TypedDict, closed=True):
    """
...
class ArrayType(TypedDict, closed=True):
    """
...
class MapType(TypedDict, closed=True):
    """
...
class MetaModel(TypedDict, closed=True):
    """
...
class Notification(TypedDict, closed=True):
    ...
    """
    params: NotRequired[Type | list[Type]]
    """
...
class OrType(TypedDict, closed=True):
    """
...
class Structure(TypedDict, closed=True):
    """
...
class StructureLiteral(TypedDict, closed=True):
    """
...
class StructureLiteralType(TypedDict, closed=True):
    """
...
class TupleType(TypedDict, closed=True):
    """
...
class TypeAlias(TypedDict, closed=True):
    """
