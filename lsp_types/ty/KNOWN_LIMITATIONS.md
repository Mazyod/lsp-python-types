...
These limitations were documented based on ty version 0.0.11 (January 2026), last verified with ty 0.0.61 (July 2026). Hover-shows-type-only and `completionItem/resolve` returning `-32601` were both re-confirmed against 0.0.61. Future versions may address some of these limitations.
